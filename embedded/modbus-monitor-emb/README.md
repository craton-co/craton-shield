...
| 9 | Timestamp anomaly |
| 10 | Rate-limit bucket table exhausted (LRU eviction occurred) |
| 11 | Exception counter table exhausted (LRU eviction occurred) |
| 12 | Write attempt to broadcast (`unit_id == 0`) |
| 13 | PDU length does not match spec for the function code |
