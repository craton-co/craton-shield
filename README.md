...
|:---|:---|---:|:---|
| **Core** | Shared security primitives | 23 | CAN, Ethernet, SOME/IP |
...
<details>
<summary>49 crates across 4 domains</summary>
...
| `vs-health` | Per-subsystem health state machine with deterministic auto-recovery |
| `vs-evidence-envelope` | Structured metadata envelope for compliance/audit reports -- see SECURITY note |
